...
_BUILTIN_GENE_SUMMARIES: dict[str, str] = {
    ...
    "BRCA1": (
        ...
        "המשמעות של הממצא הספציפי נקבעת על ידי הצוות הגנטי בהתאם לדוח ולהיסטוריה המשפחתית."
    ),
    "BRCA2": (
